...
.elisa-card {border:1px solid #e6e6e6;border-radius:12px;padding:14px;background:#fff;}
...
<div class="elisa-grid">
  <div class="elisa-card"><div class="elisa-step">1) 🧫 Coating</div><div class="elisa-body">Antigen or antibody is attached to the microplate well surface.</div></div>
  <div class="elisa-card"><div class="elisa-step">2) 🚫 Blocking</div><div class="elisa-body">Empty areas are blocked to prevent non-specific sticking.</div></div>
  <div class="elisa-card"><div class="elisa-step">3) 🔗 Binding</div><div class="elisa-body">Sample is added; if the target is present, it binds to the coated capture partner.</div></div>
  <div class="elisa-card"><div class="elisa-step">4) 🧷 Detection Ab</div><div class="elisa-body">An enzyme-linked detection antibody binds to the captured target.</div></div>
  <div class="elisa-card"><div class="elisa-step">5) 🎨 Substrate → Color</div><div class="elisa-body">Substrate reacts with the enzyme to produce a colored product.</div></div>
  <div class="elisa-card"><div class="elisa-step">6) 📟 Measure OD</div><div class="elisa-body">A plate reader measures color as Optical Density (OD). More color ⇒ more target.</div></div>
</div>
""", unsafe_allow_html=True)
...
.fmt-card {border:1px solid #e6e6e6;border-radius:12px;padding:14px;background:#fff;}
...
<div class="fmt-grid">
  <div class="fmt-card">
    ...
    <div class="fmt-body">Plate-bound <b>antigen</b> is detected by a single <b>enzyme-linked primary antibody</b>. Fewer steps, faster, but may be less signal amplification.</div>
  </div>
  <div class="fmt-card">
    <div class="fmt-title">2) Indirect ELISA <span class="fmt-badge">More analyte → More color</span></div>
    <div class="fmt-body">Plate-bound <b>antigen</b> + <b>primary antibody</b> (unlabeled) + <b>enzyme-linked secondary antibody</b>. Secondary Ab provides <b>signal amplification</b> and flexibility.</div>
  </div>
  <div class="fmt-card">
    <div class="fmt-title">3) Sandwich ELISA <span class="fmt-badge">More analyte → More color</span></div>
    <div class="fmt-body">Plate-bound <b>capture antibody</b> grabs the <b>antigen</b>; a second <b>enzyme-linked detection antibody</b> binds it. High <b>specificity</b> and sensitivity; common for diagnostics.</div>
  </div>
  <div class="fmt-card">
    <div class="fmt-title">4) Competitive ELISA <span class="fmt-badge">More analyte → Less color</span></div>
    <div class="fmt-body">Sample analyte competes with a labeled version for limited binding sites. <b>Higher analyte gives lower signal</b> (inverse relationship).</div>
  </div>
</div>
